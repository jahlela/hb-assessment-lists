...
def all_odd(numbers):
    ...
    odd_items = [number for number in numbers if number % 2 == 1]
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    def make_list_set(old_list):
        """
        Takes a list and returns a set.
        """
    ...
    food_set_1 = make_list_set(foods1)
    food_set_2 = make_list_set(foods2)

    return sorted(food_set_1 & food_set_2)
...
def largest_n_items(items, n):
    ...
    if n == 0:
        ...
        return sorted_items[length-n:length]
